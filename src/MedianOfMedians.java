...
public class MedianOfMedians {
	 ...
	 * 
	 * @param list
	 *            list to search, which may be reordered on return
	 ...
	 * 
	 * @param list
	 *            list to search, whose sub-list may be shuffled before
	 *            returning
	 * @param lo
	 *            first element of sub-list in list
	 * @param hi
	 *            just after last element of sub-list in list
	 * @param k
